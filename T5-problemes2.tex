...
\draw
  (6,-3) node[or gate, draw, inputs=nnn] (or) {}
...
\node at (4,-2) [and gate, draw, inputs=nn] (and1) {};
\node at (4.8,-2) [not gate US, draw] (andn1) {};
\draw (and1.output) -- (andn1.input);
\foreach \a in {1,...,2}
  \draw (and1.input \a -| -0.5,0) -- (and1.input \a);

\node at (4,-3) [and gate, draw, inputs=nn] (and2) {};
\node at (4.8,-3) [not gate US, draw] (andn2) {};
\draw (and2.output) -- (andn2.input);
\foreach \a in {1,...,2}
  \draw (and2.input \a -| -0.5,0) -- (and2.input \a);

\node at (4,-4) [and gate, draw, inputs=nn] (and3) {};
\node at (4.8,-4) [not gate US, draw] (andn3) {};
\draw (and3.output) -- (andn3.input);
\foreach \a in {1,...,2}
  \draw (and3.input \a -| -0.5,0) -- (and3.input \a);
...
\draw
  (6,-3) node[and gate, draw, inputs=nnn] (or) {}
...
(0.0,0) coordinate (d) node[anchor=south] {$a$} (d) -- ++(0,-4.7)
(d) ++(.5, -1) node[xor gate, draw, inputs=nn, point down] (d_not) {}
...
\node at (4,-4) [and gate, draw, inputs=nnn] (and3) {};
\foreach \a in {1,...,3}
  \draw (and3.input \a -| -0.5,0) -- (and3.input \a);

\draw
  (5.3,-3) node[xor gate, draw, inputs=nnn] (or) {}
...
(d) ++(.5, -1) node[nand gate, draw, inputs=nn, point down] (d_not) {}
...
\node at (4,-2) [nand gate, draw, inputs=nn] (and1) {};
\foreach \a in {1,...,2}
  \draw (and1.input \a -| -0.5,0) -- (and1.input \a);

\node at (4,-3) [nand gate, draw, inputs=nn] (and2) {};
\foreach \a in {1,...,2}
  \draw (and2.input \a -| -0.5,0) -- (and2.input \a);

\node at (4,-4) [nand gate, draw, inputs=nn] (and3) {};
\foreach \a in {1,...,2}
  \draw (and3.input \a -| -0.5,0) -- (and3.input \a);

\node at (4,-5) [nand gate, draw, inputs=nnn] (and4) {};
\foreach \a in {1,...,3}
  \draw (and4.input \a -| -0.5,0) -- (and4.input \a);

\draw
  (5.5,-3.5) node[nand gate, draw, inputs=nnnn] (or) {}
  (or.input 1) -- ++(-0.2,0) |- (and1.output)
...
\begin{center} \begin{tikzpicture}[circuit logic US] \draw
  ...
  (1.0,0.75) node[xor gate, draw] (xor1) {}
  ($ (2.3,0.75)!.5!(2.3,0) $) node[xor gate, draw] (xor2) {}
